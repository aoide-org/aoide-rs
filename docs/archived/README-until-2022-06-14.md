...
Playlists are an ordered collection of _entries_. Most entries reference a
...
Once started the server will respond with a static HTML page when sending a GET
