...
"sort_album_artist" AS "sort_artist",
"sort_album_title" AS "sort_title"
FROM "track"
...
CREATE VIEW "view_album_sort_artist_initial" AS
SELECT
upper(substr("sort_artist",1,1)) AS "sort_artist_initial",
count(*) AS "album_count"
FROM "view_album"
GROUP BY "sort_artist_initial";
