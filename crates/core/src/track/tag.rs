...
pub static FACET_ID_ISRC: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_ISRC));
...
pub static FACET_ID_GROUPING: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_GROUPING));
...
pub static FACET_ID_COMMENT: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_COMMENT));
...
pub static FACET_ID_DESCRIPTION: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_DESCRIPTION));
...
pub static FACET_ID_LANGUAGE: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_LANGUAGE));
...
pub static FACET_ID_GENRE: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_GENRE));
...
pub static FACET_ID_MOOD: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_MOOD));

// Custom: Decades like "1980s", "2000s", ..., or other time-based properties
pub const FACET_DECADE: &str = "decade";
pub static FACET_ID_DECADE: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_DECADE));

// Custom: Sub-genres or details like "East Coast", "West Coast", ...
pub const FACET_STYLE: &str = "style";
pub static FACET_ID_STYLE: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_STYLE));
...
pub static FACET_ID_VIBE: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_VIBE));
...
pub static FACET_ID_ACOUSTICNESS: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_ACOUSTICNESS));

pub const FACET_AROUSAL: &str = "arousal";
pub static FACET_ID_AROUSAL: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_AROUSAL));

pub const FACET_DANCEABILITY: &str = "danceability";
pub static FACET_ID_DANCEABILITY: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_DANCEABILITY));

pub const FACET_ENERGY: &str = "energy";
pub static FACET_ID_ENERGY: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_ENERGY));

pub const FACET_INSTRUMENTALNESS: &str = "instrumentalness";
pub static FACET_ID_INSTRUMENTALNESS: FacetId<'_> =
    FacetId::new(Cow::Borrowed(FACET_INSTRUMENTALNESS));

pub const FACET_LIVENESS: &str = "liveness";
pub static FACET_ID_LIVENESS: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_LIVENESS));

pub const FACET_POPULARITY: &str = "popularity";
pub static FACET_ID_POPULARITY: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_POPULARITY));

pub const FACET_SPEECHINESS: &str = "speechiness";
pub static FACET_ID_SPEECHINESS: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_SPEECHINESS));

pub const FACET_VALENCE: &str = "valence";
pub static FACET_ID_VALENCE: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_VALENCE));
...
pub static FACET_ID_XID: FacetId<'_> = FacetId::new(Cow::Borrowed(FACET_XID));
